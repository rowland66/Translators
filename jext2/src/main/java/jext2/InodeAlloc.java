...
public class InodeAlloc {
	 ...
	 */
	private static int findGroupDir(Inode parent) throws NoSpaceLeftOnDevice {
	...
	private static int findGroupOther(Inode parent) throws NoSpaceLeftOnDevice {
		int groupsCount = superblock.getGroupsCount();
	...
	private static int findGroupOrlov(Inode parent) {
		// TODO implement me
		return -1;
	}
	...
	public static synchronized void registerInode(Inode dir, Inode inode) throws JExt2Exception {
		...
		while (true) {
			...
			if (globalIno < superblock.getFirstIno() ||
				...
				continue; // TODO: Fix me. This looks like a potentially endless loop.
			}
